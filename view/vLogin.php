<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <form class="container" name="formMiCuenta" action="<?php echo $_SERVER['PHP_SELF']; ?>" action="POST">
        <ul class="nav nav-pills">
            <li class="nav-item">
                <input style="margin-right: 5px;" class="btn btn-outline-danger" type="button" name="cancelar" id="cancelar" value="Menú Principal" onclick="location.href = '../../index.php'"/>
            </li>
            <li class="nav-item">
...
<div id="carouselExampleIndicators" class="carousel slide container" data-interval="false">
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img class="d-block w-100" src="webroot/images/180503ArbolDeNavegacion.jpg" alt="First slide">
        </div>
        ...
        <div class="carousel-item">
            <img class="d-block w-100" src="webroot/images/180503RelacionDeFicheros.jpg" alt="Second slide">
        </div>
        <div class="carousel-item">
            <img class="d-block w-100" src="webroot/images/EstructuraDeAlmacenamiento.JPG" alt="Third slide">
        </div>
    </div>
